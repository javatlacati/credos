export const initialNodes = [
  ...
  {id: 'c3', type: 'input', parentId: 'c0.1', position: {x: 0, y: 300}, data: {label: 'Anglicano'}, extent: 'parent'},
  {
    id: 'c4', parentId: 'c1', position: {x: 0, y: 400}, data: {label: 'Fariseo'}, extent: 'parent'
  }, {
    id: 'c5', parentId: 'c1', position: {x: 0, y: 400}, data: {label: 'Saduceo'}, extent: 'parent'
  }, {
    id: 'c6', parentId: 'c2', position: {x: 0, y: 450}, data: {label: 'La Luz Del Mundo'}, extent: 'parent'
  }, {
    id: 'c7', parentId: 'c0.1', position: {x: 0, y: 450}, data: {label: 'Catolico Ortodoxo Oriental'}, extent: 'parent'
  }, {
    id: 'c8', parentId: 'c0.1', position: {x: 0, y: 460}, data: {label: 'Catolico Ortodoxo Del Este'}, extent: 'parent'
  }, {
    id: 'c9', parentId: 'c0.2', position: {x: 0, y: 460}, data: {label: 'Luterano'}, extent: 'parent'
  }, {
    id: 'c10', parentId: 'c0.2', position: {x: 0, y: 460}, data: {label: 'Presbiteriano'}, extent: 'parent'
  }, {
    id: 'c11', parentId: 'c0.2', position: {x: 0, y: 460}, data: {label: 'Calvinista'}, extent: 'parent'
  }, {
    id: 'c12', parentId: 'c0.2', position: {x: 0, y: 460}, data: {label: 'Anabaptista'}, extent: 'parent'
  }, {
    id: 'c13', parentId: 'c0.3', position: {x: 0, y: 460}, data: {label: 'Metodista'}, extent: 'parent'
  }, {
    id: 'c14', parentId: 'c0.3', position: {x: 0, y: 460}, data: {label: 'Bautista'}, extent: 'parent'
  }, {
    id: 'c15', parentId: 'c0.3', position: {x: 0, y: 460}, data: {label: 'Bautista Reformado'}, extent: 'parent'
  }, {
    id: 'c16',
    parentId: 'c0.1',
    position: {x: 0, y: 460},
